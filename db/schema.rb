...
ActiveRecord::Schema.define(version: 2022_01_10_165549) do
  ...
  create_table "orders", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["start_rent_date", "end_rent_date", "item_id"], name: "index_orders_on_start_rent_date_and_end_rent_date_and_item_id", unique: true
  end
