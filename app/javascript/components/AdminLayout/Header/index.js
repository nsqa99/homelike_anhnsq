...
const Header = () => {
  ...
  return (
    <Navbar color="light" expand={true} light className="sticky-top">
      <RouterLink to="/admin" className="navbar-brand text-danger fw-bold">
        HomeLike Admin
      </RouterLink>
      {/* <RouterLink to={`/admin/${authData.username}`} className="navbar-brand">
        Users
      </RouterLink> */}
      {/* <RouterLink to={`/admin/${authData.username}/orders`} className="navbar-brand">
        Orders
      </RouterLink> */}
      ...
      <Nav className="ms-auto" navbar>
        ...
        <Dropdown isOpen={isOpen} toggle={toggle} nav inNavbar>
          ...
          <DropdownMenu styleName="dropdown-menu--right-align">
              {/* <RouterLink to={`/admin/${authData.username}`}>
